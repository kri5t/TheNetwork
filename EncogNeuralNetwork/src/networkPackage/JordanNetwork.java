...
public class JordanNetwork {
	...
	public static void main(final String args[]) {
		...
		final BasicNetwork jordanNetwork = JordanNetwork.createJordanNetwork();
		final BasicNetwork feedforwardNetwork = JordanNetwork
				.createFeedforwardNetwork();

		final double jordanError = JordanNetwork.trainNetwork("Jordan", jordanNetwork,
				trainingSet);
		final double feedforwardError = JordanNetwork.trainNetwork("Feedforward",
